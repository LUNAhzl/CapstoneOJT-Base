...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">OJTime: OJT-RM</a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Login and Registration</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="../ojtime/index.php" data-bs-toggle="modal" data-bs-target="#exampleModal5">Student Registration</a></li>
              <li><a href="../ojtime/index.php" data-bs-toggle="modal" data-bs-target="#exampleModal6">Employer Registration</a></li>
            </ul>
          </li>
          ...
          <div class="modal-body">
            ...
            <form action="process.php" method="POST">
              ...
              <div class="input-group mb-3">
                ...
                <input type="email" class="form-control" name="ad_email" placeholder="Enter Email" required>
              </div>
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control" name="ad_pass" id="myInput" placeholder="Enter Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.">
              </div>
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="ad_id" name="ad_id" placeholder="Enter ID" required>
              </div>
          ...
          <div class="modal-body">
            ...
            <form action="process.php" method="POST">
              ...
              <div class="input-group mb-3">
                ...
                <input type="email" class="form-control" name="emp_email" placeholder="Enter Email" required>
              </div>
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control" name="emp_pass" id="myInput3" placeholder="Enter Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.">
              </div>
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" id="cp_id" name="cp_id" placeholder="Enter Company ID" required>
              </div>
    
              <div class="modal-footer">
                <input type="reset" class="btn btn-secondary" value="CLEAR">
                <input type="submit" class="btn btn-primary" name="employer_login" value="LOGIN">
              </div>
          ...
          <div class="modal-body">
            ...
            <form action="process.php" method="POST">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="sc_id" placeholder="Enter School ID" required>
              </div>
              ...
              <div class="input-group">
                ...
                <select id="course" name="course" required>
                  <option hidden="Course">Course</option>
          ...
          <div class="modal-body">
            ...
            <form action="process.php" method="POST">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="cp_id" placeholder="Enter Company ID" required>
              </div>
              ...
              <div class="input-group">
                ...
                <input type="password" class="form-control" name="pass" id="myInput6" placeholder="Enter Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.">
              </div>
              ...
              <div class="modal-footer">
                <input type="reset" class="btn btn-secondary" value="CLEAR">
                <input type="submit" class="btn btn-primary" name="reg_employer" value="REGISTER">
              </div>
