  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Organization Lists</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="tab-content">
              <div class="tab-pane fade show active" id="list" role="tabpanel">
                  <div class="row clearfix">
                      ...
                      $getprofile = mysqli_query($conn, "SELECT *, COUNT(*) AS total_students FROM create_profile GROUP BY e_name ORDER BY company ASC");
                          ...
                          <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="card mb-3">
                                  <div class="card-header">
                                      <h5 class="card-title"><?php echo $row['company']; ?></h5>
                                  </div>
                                  <div class="card-body">
                                      <h2><?php echo $row['e_name']; ?></h3>
                                      <p><strong>Position:</strong> <?php echo $row['position']; ?></p>
                                      <p><strong>Contact Number:</strong> <?php echo $row['e_contact']; ?></p>
                                      <p><strong>Email:</strong> <?php echo $row['e_email']; ?></p>
                                      <hr>
                                      <h5><strong>Total Student:</strong> <?php echo $row['total_students'] ?></h5>
                                  </div>
                              </div>
                          </div>
                      <?php
