  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Coordinator Lists</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="tab-content">
              <div class="tab-pane fade show active" id="list" role="tabpanel">
                  <div class="row clearfix">
                      ...
                      // Query to fetch one data entry per company
                      // Query to fetch coordinators and count of students for the Tourism Management course
                      $getprofile= mysqli_query($conn, "SELECT *, COUNT(*) AS total_students FROM create_profile GROUP BY coordinator ORDER BY course ASC");
                      ...
                      ?>
                          <div class="col-xl-6 col-lg-6 col-md-6">
                              <div class="card mb-3">
                                  ...
                                  <div class="card-body">
                                        <h2><?php echo $row['coordinator'] ?></h2>
                                        <h5><strong>Contact Number:</strong> <?php echo $row['coor_contact'] ?></h5>
                                        <h5><strong>Email:</strong> <?php echo $row['coor_email'] ?></h5>
                                        <hr>
                                        <h5><strong>Total Student Handled:</strong> <?php echo $row['total_students'] ?></h5>
                                        <hr>
                                  </div>
                              </div>
                          </div>
