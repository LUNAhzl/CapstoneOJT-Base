  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Appplicant Lists</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                                        ...
                                        <div class="card-body">
                                            <table class="table app-table-hover mb-0 text-left">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $course_row['sc_id'] ?></td>
                                                            <td><?php echo $course_row['fname'] ?></td>
                                                            <td><?php echo $course_row['mname'] ?></td>
                                                            <td><?php echo $course_row['lname'] ?></td>
                                                            <td><?php echo $course_row['age'] ?></td>
                                                            <td><?php echo $course_row['gender'] ?></td>
                                                            <td><?php echo $course_row['course'] ?></td>
                                                            <td><?php echo $course_row['contact'] ?></td>
                                                            <td><?php echo $course_row['sc_email'] ?></td>
                                                            <td><?php echo $course_row['address'] ?></td>
                                                        </tr>
                                                    <?php
                                                    }
                                                    ?>
